"""
Django settings for AgoraVibes project.
...
WSGI_APPLICATION = 'AgoraVibes.wsgi.application'
...
if 'DATABASE_URL' in os.environ and os.environ.environ.get('DATABASE_URL'):
